    ...
    <div style="padding: 0.5cm 0.5cm; margin: 0px auto 0px 10px;">
        ...
        <table class="table-common" style="width: 100%;align-self:left;">
            <tr>
                ...
                <td style="width:1%">:</td>
                <td style="width:80%"><?php echo $nama ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width:1%">:</td>
                <td style="width:80%">Transfer Sertifikasi</td>
            </tr>
            <tr>
            ...
            <!-- <tr>
                <td style="width:19%">Tanggal Transfer</td>
                <td style="width:1%">:</td>
                <td style="width:80%"><?php echo $tanggal_transfer ?></td>
            </tr> -->
            <tr>
