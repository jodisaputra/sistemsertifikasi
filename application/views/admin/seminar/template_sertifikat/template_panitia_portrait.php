...
<body>
  ...
  <p align="center" style="text-align: center; font-size: 25px; font-weight: bold; margin-top: 40px;"><?php echo $list->pan_nama ?></p>
  ...
  <h1 align="center" style="font-size: 30px !important; text-align: center; margin-top: 15px;">Panitia</h1>
